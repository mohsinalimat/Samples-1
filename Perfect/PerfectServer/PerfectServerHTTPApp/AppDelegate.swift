...
class AppDelegate: NSObject, NSApplicationDelegate {
	...
	var documentRoot: String = "/Users/LE/Downloads/PerfectTutorial-master/Perfect Web Service Server" {
		didSet {
	...
	override init() {
		...
		self.documentRoot = NSUserDefaults.standardUserDefaults().stringForKey(KEY_SERVER_ROOT) ?? "/Users/LE/Downloads/PerfectTutorial-master/Perfect Web Service Server"
	}
